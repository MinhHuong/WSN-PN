...
namespace PAT.GUI.SVModule.Base
{
    class Link
    {
        ...
        public Link(Sensor source, Sensor dest, string Ltype, int maxSendingRate, int CGN)
        {
            this.source = source;
            this.dest = dest;
            this.Ltype = Ltype;
        ...
        //public Link(Sensor source, Sensor dest, string Ltype, double transfer_rate, int CGN)
        //{
        //    this.source = source;
        //    this.dest = dest;
        //    this.Ltype = Ltype;
