...
namespace PAT.GUI.Forms
{
    public partial class OptionForm : Form
    {
        ...
        private const string TAG = "OptionForm";
        ...
        public OptionForm()
        {
            ...
            CheckBox_CheckUpdate.Checked = SettingUtils.CHECK_UPDATE_AT_START;
            CheckBox_EmailSSL.Checked = Common.Utility.Utilities.SEND_EMAIL_USE_SSL;

            CheckBox_LinkCSP.Checked = SettingUtils.LINK_CSP;
            

            CheckBox_PerformDeterminization.Checked = Ultility.PERFORM_DETERMINIZATION;

            CheckBox_AutoSave.Checked = SettingUtils.AUTO_SAVE;
            ...
            this.ComboBox_DefaultModelingLanguage.Text = SettingUtils.DEFAULT_MODELING_LANGUAGE;

            // Latex options
            CheckBox_Latex_Autosave.Checked = SettingUtils.LATEX_AUTO_SAVE;
            Label_Latex_Path.Text = SettingUtils.LATEX_PATH;
        ...
        {
            // Latex options
            this.CheckBox_Latex_Autosave.Checked = false;
        ...
        private void Button_Latex_Open_Click(object sender, EventArgs e)
        {
            string path = SettingUtils.LATEX_PATH;
