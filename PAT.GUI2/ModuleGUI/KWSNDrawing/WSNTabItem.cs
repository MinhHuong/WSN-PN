...
namespace PAT.GUI.KWSNDrawing
{
    public class WSNTabItem : KLTSTabItem, IConfigurationForm
    {
        ...
        private void initGUI()
        {
            ...
            ToolStripMenuItem exportAllImproved = new ToolStripMenuItem("Non Abstraction (Improved)");
            ToolStripMenuItem exportSensorsOnlyImproved = new ToolStripMenuItem("Channel Abstraction (Improved)");
            ToolStripMenuItem exportChanelsOnlyImproved = new ToolStripMenuItem("Sensor Abstraction (Improved)");
            ...
            exportAllImproved.Click += mConverter.convertNonAbstractImproved;
            exportSensorsOnlyImproved.Click += mConverter.convertAbstractChannelImproved;
            exportChanelsOnlyImproved.Click += mConverter.convertAbstractSensorImproved;
            ...
            mnuItemConvert2PNModel.DropDownItems.Add(exportAllImproved);
            mnuItemConvert2PNModel.DropDownItems.Add(exportSensorsOnlyImproved);
            mnuItemConvert2PNModel.DropDownItems.Add(exportChanelsOnlyImproved);
    ...
    public interface IConvertPN
    {
        ...
        void convertNonAbstractImproved(object sender, EventArgs e);
        void convertAbstractSensorImproved(object sender, EventArgs e);
        void convertAbstractChannelImproved(object sender, EventArgs e);
    }
}
