...
namespace PAT.GUI.ModuleGUI.KWSNDrawing
{
    public partial class WSNConfigForm : Form
    {
        ...
        private void LoadChannelListInfo()
        {
            ...
            mGridChannel.Columns["ProbabilityPathCongestion"].Visible = true;
            mGridChannel.Columns["ProbabilityPathCongestion"].ValueType = typeof(double);
