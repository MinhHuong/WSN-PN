...
namespace PAT.Module.KWSN
{
    ...
    public class WSNPNData
    {
        ...
        public string getInNodeName() {
            return inNode.name + nodeId;
        }

        public string getOutNodeName()
        {
            return outNode.name + nodeId;
        }

        public PointF getInNodePosition()
        {
            return new PointF(inNode.pos.x, inNode.pos.y);
        }

        public PointF getOutNodePosition()
        {
            return new PointF(outNode.pos.x, outNode.pos.y);
        }
    }
