...
namespace PAT.Common.Utility
{
    public class SettingUtils
    {
        ...
        public static bool LATEX_AUTO_SAVE = false;
        public static string LATEX_PATH = "";
        ...
        public static void ReadSettingValue()
        {
            ...
            ////Latex auto save
            LATEX_AUTO_SAVE = ConfigSettings.Settings.GetOption("Setting", "LATEX_AUTO_SAVE", LATEX_AUTO_SAVE.ToString()) == "True";
        }
        ...
        public static void SaveSettingValue()
        {
            ...
            ////setup
            ConfigSettings.Settings.SetOption("Setting", "LATEX_AUTO_SAVE", LATEX_AUTO_SAVE.ToString());
