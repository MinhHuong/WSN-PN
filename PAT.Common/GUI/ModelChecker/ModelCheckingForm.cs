...
namespace PAT.Common.GUI.ModelChecker
{
    public partial class ModelCheckingForm : Form, ResourceFormInterface, ISpecificationWorker
    {
        ...
        public int count_assertion = 0;
        //public LatexResult1 mLatexResult1;
        public LatexWorker mLatexWorker;
        ...
        public void handleResult()
        {
            do
            {
                if (SettingUtils.LATEX_AUTO_SAVE)
                {
                    mLatexWorker.checkForMethod();
                    break;
                }

                DialogResult dr = MessageBox.Show("Do you want to save result?", "Message", MessageBoxButtons.YesNo);
        ...
        //public void save(LatexResult1 latexresult, PNExtendInfo pnInfo)
        //{
        //    mLatexResult1 = latexresult;
        //    mExtendInfo = pnInfo;            
        //}


        public void getTimeOut(int TimeOutOrBroken)
        {
